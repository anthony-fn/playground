package com.anthony.playground.spring.mvc;
...
import com.anthony.playground.spring.mvc.data.SpittleRepository;
import com.anthony.playground.spring.mvc.web.SpittleController;
...
public class SpittleControllerTest {
  ...
  public void shouldShowRecentSpittles() throws Exception {
    ...
    MockMvc mockMvc = standaloneSetup(controller)
        .setSingleView(new InternalResourceView("/WEB-INF/spring/mvc/views/spittles.jsp"))
        .build();
